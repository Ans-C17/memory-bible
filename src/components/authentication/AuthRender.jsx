  ...
  if (user) return; //return heyuser
      ...
      <>
        ...
        <div className="w-72 h-16 absolute space-x-2 top-82 right-10 flex items-center justify-center border-2 border-cyan-300 rounded-b-2xl bg-cyan-800 font-anek text-lg">
          ...
          <button
            ...
            className="text-blue-300 hover:underline hover:scale-110 hover:text-blue-400 transition-all"
          >
            Sign Up
          </button>
        </div>
    ...
    return (
      <>
        ...
        <div className="w-72 h-16 absolute space-x-2 top-82 right-10 flex items-center justify-center border-2 border-cyan-300 rounded-b-2xl bg-cyan-800 font-anek text-md">
